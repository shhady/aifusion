...
export function GlobeDemo() {
  ...
  return (
    (<div
      className="flex flex-row items-center justify-center pt-20 md:pt-40 lg:pt-20 h-screen  bg-[#131313]  relative w-full">
      <div
        className=" grid lg:grid-cols-2 grid-cols-1 items-center justify-center mx-auto w-full relative overflow-hidden h-full  px-4">
        <motion.div
          initial={{
            opacity: 0,
            y: 20,
          ...
          className="div">
            <h2 className="text-center text-4xl font-bold text-white bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to bg-neutral-400 bg-opacity-50">AIFusion</h2>
          <h2
